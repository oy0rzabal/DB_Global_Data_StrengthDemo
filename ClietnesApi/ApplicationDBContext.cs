...
namespace ClientesAPI
{
    public class ApplicationDBContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) //Hacer las migraciones cuando este bien.
        {
            ...
            modelBuilder.Entity<PeliculaSalasDeCine>()
        ...
        //public DbSet<PeliculaSalasDeCine> PeliculaSalasDeCines { get; set; }
